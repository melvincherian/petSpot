...
import 'package:second_project/bloc/authentication_bloc.dart'; // Import your AuthenticationBloc
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: BlocProvider(
        create: (context) => AuthenticationBloc(authrepository: AuthRepository(), authRepository: AuthRepository()), // Provide your AuthenticationBloc
